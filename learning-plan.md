...
- AI 基础：有基础 | Web3 基础：有基础 | 编程：会基础脚本
- 目标方向：产品研究（Web3 产品分析 / AI+Web3 应用场景）
- 每日时间：3 小时 | 输出语言：中文为主，英文为辅

## 总体目标

深入理解 AI × Web3 交叉领域的产品逻辑与应用场景，能够输出产品分析报告和赛道研究。
...
- [ ] [Agentic Commerce](https://aiweb3.school/zh/handbook/tracks/agentic-commerce/) — Agent 驱动的商业
- [ ] [AI Security](https://aiweb3.school/zh/handbook/tracks/ai-security/) — AI 安全赛道
- [ ] [Dev Tooling](https://aiweb3.school/zh/handbook/tracks/dev-tooling/) — 开发者工具
